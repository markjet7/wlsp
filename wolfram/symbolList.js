	...
	},
	{
		...
		"children":[
			...
			},
			{
				"name":"co2CaptureCost",
				"kind":"Symbol",
				"definition":"co2CaptureCost[co2_, co20_:5391.09, c0_:233.92, n_:0.61, op0_:0.064, i_:0.13]:=(1*^6*i*c0*(co2\/co20)^n + op0*co2)",
				"location":{
					"uri":"file:\/\/\/Users\/mark\/Library\/CloudStorage\/OneDrive-IowaStateUniversity\/Dropbox\/Research\/National%20Getting%20to%20Negative\/functions.wl",
					"range":{
						"start":{
			...
			},
			{
				...
				"kind":"Symbol",
				"definition":"co2CompressionCost[co2_, co20_:4848.94, c0_:30.38, n_:0.77, op0_:0.073, i_:0.13]:=(1*^6*i*c0*(co2\/co20)^n + op0*co2)",
				"location":{
					"uri":"file:\/\/\/Users\/mark\/Library\/CloudStorage\/OneDrive-IowaStateUniversity\/Dropbox\/Research\/National%20Getting%20to%20Negative\/functions.wl",
					"range":{
						"start":{
			...
			},
			{
				...
				"kind":"Symbol",
				"definition":"h2liquefactionCost[h2_, c0_:7.23, n_:0.8, op0_:8.763]:=(1*^6*c0*(h2)^n + op0*h2)",
				"location":{
					"uri":"file:\/\/\/Users\/mark\/Library\/CloudStorage\/OneDrive-IowaStateUniversity\/Dropbox\/Research\/National%20Getting%20to%20Negative\/functions.wl",
					"range":{
						"start":{
